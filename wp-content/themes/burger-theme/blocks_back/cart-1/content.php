                            ...
                            <div class="shop_table_wrapper">
                                <table
                                    ...
                                    <tr class="woocommerce-cart-form__cart-item cart_item">
                                        <td class="product-thumbnail" data-title="Product">
                                            <a href="shop-details.html"><img
                                                src="<?= NAKAMA_THEME_URL ?>/assets/images/product/product-1.webp"
                                                class="attachment-woocommerce_thumbnail size-woocommerce_thumbnail"
                                                alt="Personal holding earbud"></a>
                                        </td>
                                        <td class="product-name" data-title="Name">
                                            <h5><a href="shop-details.html">Personal
                                                holding earbud</a></h5>
                                        </td>
                                    ...
                                    <tr class="woocommerce-cart-form__cart-item cart_item">
                                        <td class="product-thumbnail" data-title="Product">
                                            <a href="shop-details.html"><img
                                                src="<?= NAKAMA_THEME_URL ?>/assets/images/product/product-7.webp"
                                                class="attachment-woocommerce_thumbnail size-woocommerce_thumbnail"
                                                alt="Base booster speaker"></a>
                                        </td>
                                        <td class="product-name" data-title="Name">
                                            <h5><a href="shop-details.html">Base
                                    ...
                                    <tr class="woocommerce-cart-form__cart-item cart_item">
                                        ...
                                        <td class="product-thumbnail" data-title="Product">
                                            <a href="shop-details.html"><img
                                                src="<?= NAKAMA_THEME_URL ?>/assets/images/product/product-6.webp"
                                                class="attachment-woocommerce_thumbnail size-woocommerce_thumbnail"
                                                alt="Cool mini USB fan"></a>
                                        </td>

                                        <td class="product-name" data-title="Name">
                                            <h5><a href="shop-details.html">Cool
                                                mini USB fan</a></h5>
                                        </td>
