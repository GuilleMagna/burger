...
<section class="tj-blog-section section-gap slidebar-stickiy-container">
    ...
    <div class="row row-gap-5">
        ...
        <div class="post-details-wrapper">
            ...
            <img src="<?= NAKAMA_THEME_URL ?>/assets/images/service/service-details.webp" alt="Images">
            </div>
            ...
            <div class="images-wrap">
                ...
                <div class="col-sm-6">
                    ...
                    <img src="<?= NAKAMA_THEME_URL ?>/assets/images/service/service-3.webp" alt="Image">
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="image-box wow fadeInUp" data-wow-delay=".5s">
                    <img src="<?= NAKAMA_THEME_URL ?>/assets/images/service/service-4.webp" alt="Image">
                    </div>
                </div>
                </div>
            </div>
        ...
        <div class="tj-main-sidebar slidebar-stickiy">
            ...
            <ul>
                <li><a class="active" href="service-details.html">Customer Experience<span class="icon"><i
                        class="tji-arrow-right"></i></span></a></li>
                <li><a href="service-details.html">Training Programs<span class="icon"><i
                        class="tji-arrow-right"></i></span></a></li>
                <li><a href="service-details.html">Business Strategy<span class="icon"><i
                        class="tji-arrow-right"></i></span></a></li>
