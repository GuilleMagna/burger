            ...
            <div class="row section-bottom-gap product">
                    ...
                    <div
                        ...
                        <button class="nav-link tj-pdt-thumb-img active" id="thumb-1-tab"
                            ...
                            aria-controls="thumb-1" aria-selected="true"><img
                                src="<?= NAKAMA_THEME_URL ?>/assets/images/product/product-1.webp" alt="images"></button>
                        <button class="nav-link tj-pdt-thumb-img" id="thumb-2-tab" data-bs-toggle="pill"
                            ...
                            aria-selected="false"><img src="<?= NAKAMA_THEME_URL ?>/assets/images/product/product-11.webp"
                                alt="images"></button>
                        <button class="nav-link tj-pdt-thumb-img" id="thumb-3-tab" data-bs-toggle="pill"
                            ...
                            aria-selected="false"><img src="<?= NAKAMA_THEME_URL ?>/assets/images/product/product-1.webp"
                                alt="images"></button>
                        <button class="nav-link tj-pdt-thumb-img" id="thumb-4-tab" data-bs-toggle="pill"
                            ...
                            aria-selected="false"><img src="<?= NAKAMA_THEME_URL ?>/assets/images/product/product-2.webp"
                                alt="images"></button>
                        </div>
                        ...
                        <div class="tab-pane fade show active" id="thumb-1" role="tabpanel"
                            ...
                            <div class="product-img-area">
                                <div class="product-img">
                                    <img src="<?= NAKAMA_THEME_URL ?>/assets/images/product/product-1.webp" alt="">
                                </div>
                            </div>
                        </div>
                        <div class="tab-pane fade" id="thumb-2" role="tabpanel"
                            ...
                            <div class="product-img-area">
                                <div class="product-img">
                                    <img src="<?= NAKAMA_THEME_URL ?>/assets/images/product/product-11.webp" alt="">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="tab-pane fade" id="thumb-4" role="tabpanel"
                            ...
                            <div class="product-img-area">
                                <div class="product-img">
                                    <img src="<?= NAKAMA_THEME_URL ?>/assets/images/product/product-2.webp" alt="">
                                </div>
                            </div>
                        </div>
                        </div>
                ...
                <div class="col-xl-6 col-lg-6">
                    <div class="tj-product-details-wrapper">
                        ...
                        <!-- buy now button -->
                        <a href="checkout.html" class="tj-product-details-buy-now-btn w-100">
                                    ...
                                    <div class="comments-area">
                                        ...
                                        <ol class="commentlist">
                                            <li class="review">
                                                ...
                                                <img class="avatar" src="<?= NAKAMA_THEME_URL ?>/assets/images/blog/avatar-1.webp"
                                                    alt="">
                                                <div class="comment-text">
                                                    ...
                                                    <p class="meta">
                                                        <strong class="review__author">Berlee Hopper </strong>
                                    ...
                                    <div id="review_form_wrapper">
                                        <div id="review_form">
                                            <div id="respond" class="comment-respond">
                                                ...
                                                <p class="comment-input"><label for="comment">Type your
                                                        review&nbsp;<span
            ...
            <div class="related-products has-border">
                ...
                <div class="row rg-30 row-cols-xl-3 row-cols-lg-3 row-cols-md-2 row-cols-1">
                    <div class="tj-product">
                        ...
                        <div class="tj-product-thumb">
                            <a href="shop-details.html">
                                <img src="<?= NAKAMA_THEME_URL ?>/assets/images/product/product-1.webp" alt=""> </a>
                    ...
                    <div class="tj-product">
                        ...
                        <div class="tj-product-thumb">
                            <a href="shop-details.html">
                                <img src="<?= NAKAMA_THEME_URL ?>/assets/images/product/product-2.webp" alt=""> </a>
                    ...
                    <div class="tj-product">
                        ...
                        <div class="tj-product-thumb">
                            <a href="shop-details.html">
                                <img src="<?= NAKAMA_THEME_URL ?>/assets/images/product/product-6.webp" alt=""> </a>
