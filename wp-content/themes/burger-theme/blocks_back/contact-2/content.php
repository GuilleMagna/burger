            ...
            <div class="col-lg-6">
                ...
                <!--div class="testimonial-wrapper-3 wow fadeInUp" data-wow-delay=".5s">
                    ...
                    <div class="swiper testimonial-slider-2 h4-testimonial">
                        ...
                        <h3 class="tes-title">
                            Opiniones de clientes (4.8<span>/en 200</span>)
                        </h3>
                        ...
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide">
                                ...
                                <div class="testimonial-item">
                                    ...
                                    <div class="desc">
                                        ...
                                        <p>
                                            Trabajar con Beltrando SRL ha sido un cambio radical para nuestro negocio. La profesionalidad,
                                            la atención al detalle y las soluciones innovadoras de su equipo nos han ayudado a optimizar nuestras operaciones y alcanzar nuestros objetivos más rápido de lo que imaginábamos. Realmente nos sentimos socios valiosos. Los resultados que hemos visto después de asociarnos.
                                        </p>
                                    ...
                                    <div class="testimonial-author">
                                        ...
                                        <div class="author-inner">
                                            ...
                                            <div class="author-img">
                                                <img src="<?= NAKAMA_THEME_URL ?>/assets/images/testimonial/client-1.webp" alt="">
                                            </div>

                                            <div class="author-header">
                                                <h4 class="title">Nombre del cliente</h4>
                                                <span class="designation">Cargo del cliente</span>
                                            </div>
                            ...
                            <div class="swiper-slide">
                                ...
                                <div class="testimonial-item">
                                    <span class="quote-icon"><i class="tji-quote"></i></span>
                                    <div class="desc">
                                    <p>Llevamos años trabajando con Beltrando SRL y continúan ofreciendo resultados excepcionales. Su equipo es proactivo, receptivo y siempre va más allá para satisfacer nuestras necesidades. Se han convertido en un contribuyente clave para nuestro crecimiento y éxito que realmente nos ayuda."
                                    </p>
                                    </div>
                                    <div class="testimonial-author">
                                    <div class="author-inner">
                                        <div class="author-img">
                                        <img src="<?= NAKAMA_THEME_URL ?>/assets/images/testimonial/client-3.webp" alt="">
                                        </div>
                                        <div class="author-header">
                                        <h4 class="title">Nombre del cliente</h4>
                                        <span class="designation">Cargo del cliente</span>
