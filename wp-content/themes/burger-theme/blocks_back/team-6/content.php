    ...
    <div class="row">
        ...
        <div class="team-item wow fadeInUp" data-wow-delay=".1s">
            ...
            <div class="team-img-inner">
                <img src="<?= NAKAMA_THEME_URL ?>/assets/images/team/team-1.webp" alt="">
            </div>
        ...
        <div class="team-item wow fadeInUp" data-wow-delay=".3s">
            <div class="team-img">
            <div class="team-img-inner">
                <img src="<?= NAKAMA_THEME_URL ?>/assets/images/team/team-2.webp" alt="">
            </div>
            <div class="social-links">
                <ul>
                <li><a href="https://www.facebook.com/" target="_blank"><i
        ...
        <div class="team-item wow fadeInUp" data-wow-delay=".5s">
            <div class="team-img">
            <div class="team-img-inner">
                <img src="<?= NAKAMA_THEME_URL ?>/assets/images/team/team-3.webp" alt="">
            </div>
            <div class="social-links">
                <ul>
                <li><a href="https://www.facebook.com/" target="_blank"><i
        ...
        <div class="team-item wow fadeInUp" data-wow-delay=".7s">
            <div class="team-img">
            <div class="team-img-inner">
                <img src="<?= NAKAMA_THEME_URL ?>/assets/images/team/team-4.webp" alt="">
            </div>
            <div class="social-links">
                <ul>
                <li><a href="https://www.facebook.com/" target="_blank"><i
        ...
        <div class="team-item wow fadeInUp" data-wow-delay=".1s">
            <div class="team-img">
            <div class="team-img-inner">
                <img src="<?= NAKAMA_THEME_URL ?>/assets/images/team/team-5.webp" alt="">
            </div>
            <div class="social-links">
                <ul>
                <li><a href="https://www.facebook.com/" target="_blank"><i
        ...
        <div class="team-item wow fadeInUp" data-wow-delay=".3s">
            <div class="team-img">
            <div class="team-img-inner">
                <img src="<?= NAKAMA_THEME_URL ?>/assets/images/team/team-6.webp" alt="">
            </div>
            <div class="social-links">
                <ul>
                <li><a href="https://www.facebook.com/" target="_blank"><i
        ...
        <div class="team-item wow fadeInUp" data-wow-delay=".5s">
            <div class="team-img">
            <div class="team-img-inner">
                <img src="<?= NAKAMA_THEME_URL ?>/assets/images/team/team-7.webp" alt="">
            </div>
            <div class="social-links">
                <ul>
                <li><a href="https://www.facebook.com/" target="_blank"><i
        ...
        <div class="team-item wow fadeInUp" data-wow-delay=".7s">
            <div class="team-img">
            <div class="team-img-inner">
                <img src="<?= NAKAMA_THEME_URL ?>/assets/images/team/team-8.webp" alt="">
            </div>
            <div class="social-links">
                <ul>
                <li><a href="https://www.facebook.com/" target="_blank"><i
