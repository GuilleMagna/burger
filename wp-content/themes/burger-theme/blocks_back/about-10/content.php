...
<section class="h10-about section-gap">
    ...
    <div class="row flex-column-reverse flex-md-row ">
        ...
        <div class="about-img-area h10-about-banner wow bounceInLeft" data-wow-delay=".3s">
            ...
            <img data-speed=".8" src="<?= NAKAMA_THEME_URL ?>/assets/images/about/h10-about-banner.webp" alt="">
            </div>
        </div>
        </div>
        ...
        <div class="h10-about-content-wrapper">
            ...
            <span class="sub-title wow fadeInUp" data-wow-delay=".3s"><i class="tji-box"></i> ABOUT OUR
                COMPANY</span>
            <h2 class="sec-title title-highlight wow fadeInUp" data-wow-delay=".3s">Powering Innovation Through
            ...
            <div class="col-12 col-md-6 d-none d-md-block d-lg-none">
                <div class="about-img-area h10-about-banner wow bounceInLeft" data-wow-delay=".3s">
                <div class="about-img">
                    <img src="<?= NAKAMA_THEME_URL ?>/assets/images/about/h10-about-banner.webp" alt="">
                </div>
                </div>
            </div>
            <div class="col-12 col-md-6 col-lg-12">
                ...
                <div class="customers-box style-3 h10-about-clients wow fadeInUp" data-wow-delay=".4s">
                    ...
                    <ul>
                        <li class="wow fadeInLeft" data-wow-delay=".2s"><img
                            src="<?= NAKAMA_THEME_URL ?>/assets/images/testimonial/client-1.webp" alt=""></li>
                        <li class="wow fadeInLeft" data-wow-delay=".3s"><img
                            src="<?= NAKAMA_THEME_URL ?>/assets/images/testimonial/client-2.webp" alt=""></li>
                        <li class="wow fadeInLeft" data-wow-delay=".4s"><img
                            src="<?= NAKAMA_THEME_URL ?>/assets/images/testimonial/client-3.webp" alt=""></li>
                ...
                <p class="desc wow fadeInUp" data-wow-delay=".4s">Recognized by industryaward leaders, award
                    winning
                ...
                <div class="h9-about-funfact h10-about-funfact">
                    ...
                    <span class="count-text">Faster Growth starts smart solutions today.</span>
                    </div>
                </div>
                </div>
            </div>
