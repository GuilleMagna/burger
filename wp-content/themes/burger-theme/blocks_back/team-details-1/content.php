...
<section class="team-details slidebar-stickiy-container">
    ...
    <div class="row justify-content-center">
        ...
        <div class="team-details__img slidebar-stickiy wow fadeInUp" data-wow-delay=".1s">
            <img src="<?= NAKAMA_THEME_URL ?>/assets/images/team/team-1-big.webp" alt="">
        </div>
        </div>
        <!-- right -->
        ...
        <div class="team-details__content">
            ...
            <span class="team-details__desig wow fadeInUp" data-wow-delay=".1s">Chief Executive</span>
            <p class="wow fadeInUp" data-wow-delay=".3s">Our mission is to empowers businesses sizes thrive
            businesses
            ...
            <h4 class="team-details__subtitle wow fadeInUp" data-wow-delay=".3s">Work experience</h4>
            <p class="wow fadeInUp" data-wow-delay=".3s">Our mission is to empowers businesses size to thrivie
                in
            ...
            <h4 class="team-details__subtitle wow fadeInUp" data-wow-delay=".3s">Professional skills</h4>
            <p class="wow fadeInUp" data-wow-delay=".3s">Our mission is to empowers businesses size to thrivie
                in
                ses ever changing marketplace We are
                committed to the delivering exceptionals the value thro strategic ins innovative approaches. Our
