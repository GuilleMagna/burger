            ...
            <div class="woocommerce">
                ...
                <div class="row rg-40" id="customer_details">
                        ...
                        <div id="order_review" class="woocommerce-checkout-review-order">
                            ...
                            <tbody>
                                ...
                                <td class="product-name">
                                    Base booster speaker&nbsp; <strong class="product-quantity">×&nbsp;1</strong>
                                </td>
                                ...
                                <tr class="cart_item">
                                <td class="product-name">
                                    Cool mini USB fan&nbsp; <strong class="product-quantity">×&nbsp;1</strong>
                                </td>
                                <td class="product-total">
                                    <span class="woocommerce-Price-amount amount"><bdi><span
                    ...
                    <div class="wc-proceed-to-checkout mt-30">
                        <a href="checkout.html" class="tj-primary-btn checkout-button button alt wc-forward">
