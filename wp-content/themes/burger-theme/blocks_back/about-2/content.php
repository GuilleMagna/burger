...
<section class="tj-about-section section-gap">
    ...
    <div class="row row-gap-4">
        ...
        <div class="about-content-area-2 wow fadeInUp" data-wow-delay=".3s">
            ...
            <img src="<?= NAKAMA_THEME_URL ?>/assets/images/about/about-3.webp" alt="Image">
        ...
        <div class="customers-box style-2 wow fadeInUp" data-wow-delay=".3s">
            ...
            <div class="customers">
            <ul>
                <li class="wow fadeInLeft" data-wow-delay=".3s"><img src="<?= NAKAMA_THEME_URL ?>/assets/images/testimonial/client-1.webp"
                    alt=""></li>
                <li class="wow fadeInLeft" data-wow-delay=".4s"><img src="<?= NAKAMA_THEME_URL ?>/assets/images/testimonial/client-2.webp"
                    alt=""></li>
                <li class="wow fadeInLeft" data-wow-delay=".5s"><img src="<?= NAKAMA_THEME_URL ?>/assets/images/testimonial/client-3.webp"
                    alt=""></li>
            ...
            <div class="star-icon zoomInOut"><img src="<?= NAKAMA_THEME_URL ?>/assets/images/shape/star.svg" alt=""></div>
        </div>
        </div>
