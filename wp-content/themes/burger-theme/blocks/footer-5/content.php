...
$content_fields = array(
    'texto_subscribe_now' => 'Subscribe Now',
    'texto_agree_to_our' => 'Agree to our',
    'texto_terms_condition' => 'Terms & Condition?',
    'texto_subscribe_now_2' => 'Subscribe Now',
                        ...
                        <div class="subscribe-form">
                            ...
                            <form action="#">
                                ...
                                <button class="tj-primary-btn d-none d-sm-flex" type="submit">
                                    <span class="btn-text"><span><?php echo esc_html( $texto_subscribe_now ); ?></span></span>
                                ...
                                <button class="tj-primary-btn d-flex d-sm-none" type="submit">
                                    <span class="btn-text"><span><?php echo esc_html( $texto_subscribe_now_2 ); ?></span></span>
                                    <span class="btn-icon"><i class="tji-arrow-right-long"></i></span>
                                </button>
                            </form>
