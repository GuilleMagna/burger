...
$content_fields = array(
    'texto_our_clients_love' => 'Our Clients Love',
...
<section class="tj-testimonial-section-3 section-gap">
    ...
    <div class="row">
        ...
        <div class="testimonial-wrapper-2 wow fadeInUp" data-wow-delay=".4s">
            <h5 class="sec-title"><?php echo esc_html( $texto_our_clients_love ); ?> <span><?php echo esc_html( $texto_feedback ); ?></span></h5>
            <div class="swiper client-thumb">
            <div class="swiper-wrapper">
                <div class="swiper-slide thumb-item">
                <div class="thumb-img">
                    <img src="<?php echo esc_url( $imagen_assets_images_testimonial_client_1_webp ); ?>" alt="Image">
                </div>
                <div class="author-header">
                    <h4 class="title"><?php echo esc_html( $texto_mevon_lane ); ?></h4>
                    <span class="designation"><?php echo esc_html( $texto_co_founder ); ?></span>
                </div>
                </div>
                <div class="swiper-slide thumb-item">
                <div class="thumb-img">
                    <img src="<?php echo esc_url( $imagen_assets_images_testimonial_client_2_webp ); ?>" alt="Image">
                </div>
                <div class="author-header">
                ...
                <div class="swiper-slide thumb-item">
                <div class="thumb-img">
                    <img src="<?php echo esc_url( $imagen_assets_images_testimonial_client_3_webp ); ?>" alt="Image">
                </div>
                <div class="author-header">
