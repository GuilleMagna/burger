...
<section class="tj-blog-section-4 section-gap">
    ...
    <div class="row">
        ...
        <div class="sec-heading style-4 text-center">
            ...
            <h2 class="sec-title title-anim"><?php echo esc_html( $texto_strategies_and_insights ); ?></h2>
        </div>
        </div>
    </div>
    <div class="row">
        ...
        <div class="h4-blog-wrap">
            ...
            <div class="blog-content">
                ...
                <h4 class="title"><a href="<?php echo esc_url( $link_blog_details_html_9 ); ?>"><?php echo esc_html( $texto_harnessing_digital_transform_a_roadmap_2 ); ?></a>
                </h4>
