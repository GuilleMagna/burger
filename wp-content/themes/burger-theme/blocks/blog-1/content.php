...
$content_fields = array(
    ...
    'texto_the_ultimate' => 'The Ultimate',
    'texto_resource' => 'Resource.',
...
<section class="tj-blog-section section-gap">
    ...
    <div class="row">
        ...
        <div class="sec-heading text-center">
            ...
            <h2 class="sec-title title-anim"><?php echo esc_html( $texto_the_ultimate ); ?> <span><?php echo esc_html( $texto_resource ); ?></span></h2>
        </div>
        </div>
    </div>
