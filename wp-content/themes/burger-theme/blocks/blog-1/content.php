...
<section class="tj-blog-section section-gap">
    ...
    <div class="row">
        ...
        <div class="sec-heading text-center">
            ...
            <h2 class="sec-title title-anim"><?php echo esc_html( $burger_get( 'texto_the_ultimate', 'The Ultimate' ) ); ?> <span><?php echo esc_html( $burger_get( 'texto_resource', 'Resource.' ) ); ?></span></h2>
        </div>
        </div>
    </div>
