...
$content_fields = array(
    ...
    'texto_maurice_dalton' => 'Maurice Dalton',
    ...
    'texto_thierry_lawson' => 'Thierry Lawson',
...
<section class="tj-blog-section h6-blog section-gap">
    ...
    <div class="row">
        ...
        <div class="sec-heading style-2 style-6 text-center">
            ...
            <h2 class="sec-title title-anim"><?php echo esc_html( $texto_the_ultimate_resource ); ?></h2>
        </div>
        </div>
    </div>
    <div class="row row-gap-4 h6-blog-wrapper">
        ...
        <div class="blog-item wow fadeInUp" data-wow-delay=".4s">
            ...
            <div class="blog-content">
            <div class="blog-meta">
                <span class="categories"><a href="<?php echo esc_url( $link_blog_details_html_7 ); ?>"><?php echo esc_html( $texto_empower ); ?></a></span>
                <span><?php echo esc_html( $texto_by_2 ); ?> <a href="<?php echo esc_url( $link_blog_details_html_8 ); ?>"><?php echo esc_html( $texto_maurice_dalton ); ?></a></span>
            </div>
        ...
        <div class="blog-item wow fadeInUp" data-wow-delay=".4s">
            ...
            <div class="blog-content">
            <div class="blog-meta">
                <span class="categories"><a href="<?php echo esc_url( $link_blog_details_html_12 ); ?>"><?php echo esc_html( $texto_support ); ?></a></span>
                <span><?php echo esc_html( $texto_by_3 ); ?> <a href="<?php echo esc_url( $link_blog_details_html_13 ); ?>"><?php echo esc_html( $texto_thierry_lawson ); ?></a></span>
            </div>
