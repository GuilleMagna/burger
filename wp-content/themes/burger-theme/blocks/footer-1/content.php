            ...
            <div class="row justify-content-between">
                ...
                <div class="col-xl-3 col-lg-4 col-md-6">
                    ...
                    <div class="footer-widget wow fadeInUp" data-wow-delay=".1s">
                        ...
                        <div class="footer-logo">
                            <a href="">
                                <img src="<?= NAKAMA_OPTIONS['logo_dark'] ?>" alt="Logos">
                            </a>
                        </div>
                ...
                <div class="col-xl-3 col-lg-4 col-md-6">
                    ...
                    <div class="footer-widget widget-nav-menu wow fadeInUp" data-wow-delay=".3s">
                        ...
                        <ul>
                            <?php foreach( (array) ( NAKAMA_OPTIONS['menu_footer_1'] ?? array() ) as $menu ): ?>

                                <?php $item = is_array( $menu ) && isset( $menu['item'] ) && is_array( $menu['item'] ) ? $menu['item'] : array() ?>
                ...
                <div class="col-xl-2 col-lg-4 col-md-6">
                    ...
                    <div class="footer-widget widget-nav-menu wow fadeInUp" data-wow-delay=".5s">
                        ...
                        <ul>
                            <?php foreach( (array) ( NAKAMA_OPTIONS['menu_footer_2'] ?? array() ) as $menu ): ?>
