...
$content_fields = array(
    ...
    'imagen_assets_images_shape_footer_bg_shape_blur' => NAKAMA_THEME_URL . '/assets/images/shape/footer-bg-shape-blur.svg',
);
...
<footer class="tj-footer-section footer-2 h5-footer h6-footer section-gap-x">
    ...
    <div class="bg-shape-3 wow fadeInUpBig" data-wow-delay="1s">
        <img src="<?php echo esc_url( $imagen_assets_images_shape_footer_bg_shape_blur ); ?>" alt="">
    </div>
