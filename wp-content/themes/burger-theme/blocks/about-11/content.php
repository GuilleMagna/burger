...
$content_fields = array(
    ...
    'texto_driving_innovation_and_excellence_for' => 'Driving Innovation and Excellence for Sustainable Corporate Success',
    'texto_worldwide' => 'Worldwide.',
    ...
    <div class="row">
        ...
        <div class="about-content-area">
            ...
            <h2 class="sec-title title-anim"><?php echo esc_html( $texto_driving_innovation_and_excellence_for ); ?>
                <span><?php echo esc_html( $texto_worldwide ); ?></span>
            </h2>
            </div>
        </div>
