...
<section class="tj-about-section-2 section-gap section-gap-x">
    ...
    <div class="row">
        ...
        <div class="about-content-area">
            ...
            <h2 class="sec-title title-anim"><?php echo esc_html( $burger_get( 'texto_driving_innovation_and_excellence_for', 'Driving Innovation and Excellence for Sustainable Corporate Success' ) ); ?>
                <span><?php echo esc_html( $burger_get( 'texto_worldwide', 'Worldwide.' ) ); ?></span>
            </h2>
            </div>
        </div>
