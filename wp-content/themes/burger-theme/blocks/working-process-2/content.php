...
<section class="h5-working-process section-gap section-gap-x ">
    ...
    <div class="row">
        ...
        <div class="sec-heading sec-heading-centered style-3">
            ...
            <h2 class="sec-title text-anim  text-white"><?php echo esc_html( $burger_get( 'texto_seamless_process_and_great_results', 'Seamless Process and Great Results.' ) ); ?></h2>
        </div>
        </div>
    </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="col-12">
            ...
            <div class="process-item h5-working-process-item wow bounceInUp" data-wow-delay=".3s">
                <h5 class="h5-working-process-indicator"><?php echo esc_html( $burger_get( 'texto_step_01', 'Step 01' ) ); ?></h5>
            ...
            <div class="process-item h5-working-process-item wow bounceInUp" data-wow-delay=".4s">
                <h5 class="h5-working-process-indicator"><?php echo esc_html( $burger_get( 'texto_step_02', 'Step 02' ) ); ?></h5>
                <div class="process-step">
                <span>02</span>
                </div>
                <div class="process-content">
            ...
            <div class="process-item h5-working-process-item wow bounceInUp" data-wow-delay=".5s">
                <h5 class="h5-working-process-indicator"><?php echo esc_html( $burger_get( 'texto_step_03', 'Step 03' ) ); ?></h5>
                <div class="process-step">
                <span>03</span>
                </div>
                <div class="process-content">
    ...
    <img src="<?php echo esc_url( $burger_get( 'imagen_assets_images_shape_shape_blur_svg_2', NAKAMA_THEME_URL . '/assets/images/shape/shape-blur.svg' ) ); ?>" alt="">
    </div>
</section>
