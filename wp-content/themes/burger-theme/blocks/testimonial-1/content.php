    ...
    <div class="row justify-content-between">
        ...
        <div class="sec-heading-wrap">
            ...
            <div class="sec-heading">
                <h2 class="sec-title title-anim"><?php echo esc_html( $burger_get( 'texto_success', 'Success' ) ); ?> <span><?php echo esc_html( $burger_get( 'texto_stories', 'Stories' ) ); ?></span> <?php echo esc_html( $burger_get( 'texto_fuel_our_innovation', 'Fuel our Innovation.' ) ); ?></h2>
            </div>
