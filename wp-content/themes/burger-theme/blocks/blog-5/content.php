...
$content_fields = array(
    ...
    'texto_strategies_and_insights' => 'Strategies and Insights.',
    ...
    'texto_innovative_solutions_for_every_busines' => 'Innovative Solutions for every Business',
    'texto_the_curve_whether_you_re_looking_to_st' => 'The curve. Whether you\'re looking to streamline operations, enhance customer experiences, or explore new market opportunities, our tailored solutions are designed to empower your business.',
...
<section class="h5-blog section-gap">
    ...
    <div class="row">
        ...
        <div class="sec-heading sec-heading-centered style-3">
            <span class="sub-title wow fadeInUp" data-wow-delay=".3s"><i class="tji-box"></i><?php echo esc_html( $texto_read_blogs ); ?></span>
            <h2 class="sec-title text-anim"><?php echo esc_html( $texto_strategies_and_insights ); ?></h2>
        </div>
    ...
    <div class="row">
        ...
        <div class="h5-blog-wrapper ">
            ...
            <div class="blog-content">
                ...
                <h4 class="title"><a href="<?php echo esc_url( $link_blog_details_html_4 ); ?>"><?php echo esc_html( $texto_innovative_solutions_for_every_busines ); ?></a></h4>
                <p class="desc"><?php echo wp_kses_post( $texto_the_curve_whether_you_re_looking_to_st ); ?></p>
                </div>
            ...
            <div class="blog-content">
                ...
                <h4 class="title"><a href="<?php echo esc_url( $link_blog_details_html_14 ); ?>"><?php echo esc_html( $texto_harnessing_digital_transform_a_roadmap ); ?></a></h4>
                </div>
